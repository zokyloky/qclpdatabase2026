...
export default function SyncManager() {
  ...
  return (
    <div className="space-y-5 w-full max-w-4xl">
      <div>
        <h1 className="font-display font-bold text-3xl text-qgray-900 tracking-tight">Sync Management</h1>
        ...
        <div className="card p-6">
          ...
          <div
            ...
            className={`border-2 border-dashed rounded-xl p-10 text-center cursor-pointer transition-colors
              ${file ? 'border-qgreen-300 bg-qgreen-50' : 'border-qgray-300 hover:border-qgray-400'}`}
          >
            <input
              ref={fileRef}
              type="file"
            ...
            {file ? (
              <div>
                <p className="font-medium text-qgreen-700">📄 {file.name}</p>
          ...
          <div className="card p-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-4">
              {[
                ...
                { label: 'Updated contacts', value: diff.updated_contacts,   className: 'text-qgreen-700 bg-qgreen-50'  },
            ...
            <div className="space-y-2">
              ...
              <DiffSection title="Updated contacts (title or role changed)" count={diff.updated_contacts} items={diff.updated_contacts_preview}
                color="border-qgreen-200 bg-qgreen-50 text-qgreen-800" />
            ...
            <tbody>
              {history.map(h => (
                <tr key={h.id} className="border-b border-qgray-50 hover:bg-qgray-50 transition-colors">
                  ...
                  <td className="px-4 py-2.5 text-center text-qgreen-700 font-semibold">{h.contacts_updated ?? '—'}</td>
